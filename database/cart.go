package database
// This file does the real MongoDB work for adding to cart, removing from cart, buying from cart, and instant buying.
// Your controllers only call these functions — the actual DB updates happen here.
...
import (
	...
	"github.com/B-Meghana-Reddy/ecommerce/models"
